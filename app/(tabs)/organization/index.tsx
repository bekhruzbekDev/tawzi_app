...
import OrganizationStatsList, {
  ResourceType,
} from "@/features/organization/ui/dashboard/stats-list";
      ...
      <ScrollView>
        {isLoading ? (
          ...
          <OrganizationStatsList
            resourceType={unitType as ResourceType}
            data={dashboardStats}
          />
        )}
        ...
        {hasBilling && !isLoading && <FinanceChart data={financeStats} />}

        {isLoading ? <AlertStatsSkeleton /> : <AlertStats data={alertStats} />}
